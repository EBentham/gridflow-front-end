...
**Path pattern**: `{data_root}/bronze/entsoe/transfer_capacity_use/<year>/<month>/<day>/raw_<uuid>.xml`
...
**Path pattern**: `{data_root}/silver/entsoe/transfer_capacity_use/year=YYYY/month=MM/transfer_capacity_use_YYYYMMDD.parquet`
