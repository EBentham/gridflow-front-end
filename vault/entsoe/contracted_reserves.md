...
**Path pattern**: `{data_root}/bronze/entsoe/contracted_reserves/<year>/<month>/<day>/raw_<uuid>.xml`
...
**Path pattern**: `{data_root}/silver/entsoe/contracted_reserves/year=YYYY/month=MM/contracted_reserves_YYYYMMDD.parquet`
