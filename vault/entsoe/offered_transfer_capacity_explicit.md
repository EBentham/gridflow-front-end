...
**Path pattern**: `{data_root}/bronze/entsoe/offered_transfer_capacity_explicit/<year>/<month>/<day>/raw_<uuid>.xml`
...
**Path pattern**: `{data_root}/silver/entsoe/offered_transfer_capacity_explicit/year=YYYY/month=MM/offered_transfer_capacity_explicit_YYYYMMDD.parquet`
