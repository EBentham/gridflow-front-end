...
**Path pattern**: `{data_root}/bronze/entsoe/congestion_income/<year>/<month>/<day>/raw_<uuid>.xml`
...
**Path pattern**: `{data_root}/silver/entsoe/congestion_income/year=YYYY/month=MM/congestion_income_YYYYMMDD.parquet`
