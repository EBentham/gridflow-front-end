...
**Path pattern**: `{data_root}/bronze/entsoe/outages_consumption/<year>/<month>/<day>/raw_<uuid>.xml`
...
**Path pattern**: `{data_root}/silver/entsoe/outages_consumption/year=YYYY/month=MM/outages_consumption_YYYYMMDD.parquet`
