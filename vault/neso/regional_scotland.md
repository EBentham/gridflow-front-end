---
source: neso
dataset_key: regional_scotland
vendor: National Energy System Operator (NESO)
last_verified: 2026-05-08
layer_coverage: bronze, silver
---

# NESO - Current Scotland carbon intensity (`regional_scotland`)
...
**Path pattern**: `{data_root}/bronze/neso/regional_scotland/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
`data[]` of period rows. Each period row holds `intensity` and `generationmix`.

```json
{"data":[{"regionid":16,"dnoregion":"Scotland","shortname":"Scotland","data":[{"from":"2026-05-08T17:30Z","to":"2026-05-08T18:00Z","intensity":{"forecast":0,"index":"very low"},"generationmix":[{"fuel":"nuclear","perc":17.5},{"fuel":"wind","perc":78.5}]}]}]}
```
...
**Path pattern**: `{data_root}/silver/neso/regional_scotland/year=<YYYY>/month=<MM>/regional_scotland_<YYYYMMDD>.parquet`
**Transformer class**: `gridflow.silver.neso.carbon_intensity.RegionalScotlandTransformer`
