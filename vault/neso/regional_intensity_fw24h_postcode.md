---
source: neso
dataset_key: regional_intensity_fw24h_postcode
vendor: National Energy System Operator (NESO)
last_verified: 2026-05-08
layer_coverage: bronze, silver
---

# NESO - Postcode regional carbon intensity forward 24h (`regional_intensity_fw24h_postcode`)
...
curl --ssl-no-revoke -X GET \
  "https://api.carbonintensity.org.uk/regional/intensity/2024-01-15T00:00Z/fw24h/postcode/RG10" \
...
**Path pattern**: `{data_root}/bronze/neso/regional_intensity_fw24h_postcode/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
**Path pattern**: `{data_root}/silver/neso/regional_intensity_fw24h_postcode/year=<YYYY>/month=<MM>/regional_intensity_fw24h_postcode_<YYYYMMDD>.parquet`
**Transformer class**: `gridflow.silver.neso.carbon_intensity.RegionalIntensityFw24HPostcodeTransformer`
