---
source: neso
dataset_key: intensity_at
vendor: National Energy System Operator (NESO)
last_verified: 2026-05-08
layer_coverage: bronze, silver
---

# NESO - National carbon intensity at datetime (`intensity_at`)
...
| Publication lag | Forecast ahead, actual as estimated after the half hour |
...
curl --ssl-no-revoke -X GET \
  "https://api.carbonintensity.org.uk/intensity/2024-01-15T00:00Z" \
...
**Path pattern**: `{data_root}/bronze/neso/intensity_at/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
**Path pattern**: `{data_root}/silver/neso/intensity_at/year=<YYYY>/month=<MM>/intensity_at_<YYYYMMDD>.parquet`
**Transformer class**: `gridflow.silver.neso.carbon_intensity.IntensityAtTransformer`
