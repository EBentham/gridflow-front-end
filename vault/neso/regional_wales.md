---
source: neso
dataset_key: regional_wales
vendor: National Energy System Operator (NESO)
last_verified: 2026-05-08
layer_coverage: bronze, silver
---

# NESO - Current Wales carbon intensity (`regional_wales`)
...
**Path pattern**: `{data_root}/bronze/neso/regional_wales/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
```json
{"data":[{"regionid":17,"dnoregion":"Wales","shortname":"Wales","data":[{"from":"2026-05-08T17:30Z","to":"2026-05-08T18:00Z","intensity":{"forecast":347,"index":"very high"},"generationmix":[{"fuel":"gas","perc":88},{"fuel":"solar","perc":7.4}]}]}]}
```
...
**Path pattern**: `{data_root}/silver/neso/regional_wales/year=<YYYY>/month=<MM>/regional_wales_<YYYYMMDD>.parquet`
**Transformer class**: `gridflow.silver.neso.carbon_intensity.RegionalWalesTransformer`
