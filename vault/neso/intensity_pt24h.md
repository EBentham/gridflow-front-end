---
source: neso
dataset_key: intensity_pt24h
vendor: National Energy System Operator (NESO)
last_verified: 2026-05-08
layer_coverage: bronze, silver
---

# NESO - National carbon intensity previous 24h (`intensity_pt24h`)
...
| Publication lag | Actual estimates may be available for completed half hours |
...
curl --ssl-no-revoke -X GET \
  "https://api.carbonintensity.org.uk/intensity/2024-01-15T00:00Z/pt24h" \
...
**Path pattern**: `{data_root}/bronze/neso/intensity_pt24h/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
**Path pattern**: `{data_root}/silver/neso/intensity_pt24h/year=<YYYY>/month=<MM>/intensity_pt24h_<YYYYMMDD>.parquet`
**Transformer class**: `gridflow.silver.neso.carbon_intensity.IntensityPt24HTransformer`
