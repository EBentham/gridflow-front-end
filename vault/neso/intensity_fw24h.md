...
**Path pattern**: `{data_root}/bronze/neso/intensity_fw24h/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
**Path pattern**: `{data_root}/silver/neso/intensity_fw24h/year=<YYYY>/month=<MM>/intensity_fw24h_<YYYYMMDD>.parquet`
