---
source: neso
dataset_key: regional_regionid
vendor: National Energy System Operator (NESO)
last_verified: 2026-05-08
layer_coverage: bronze, silver
---

# NESO - Current region-id carbon intensity (`regional_regionid`)
...
**Path pattern**: `{data_root}/bronze/neso/regional_regionid/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
```json
{"data":[{"regionid":13,"dnoregion":"UKPN London","shortname":"London","data":[{"from":"2026-05-08T17:30Z","to":"2026-05-08T18:00Z","intensity":{"forecast":185,"index":"high"},"generationmix":[{"fuel":"gas","perc":42.4},{"fuel":"imports","perc":23.2}]}]}]}
```
...
**Path pattern**: `{data_root}/silver/neso/regional_regionid/year=<YYYY>/month=<MM>/regional_regionid_<YYYYMMDD>.parquet`
**Transformer class**: `gridflow.silver.neso.carbon_intensity.RegionalRegionidTransformer`
