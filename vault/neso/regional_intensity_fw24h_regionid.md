---
source: neso
dataset_key: regional_intensity_fw24h_regionid
vendor: National Energy System Operator (NESO)
last_verified: 2026-05-08
layer_coverage: bronze, silver
---

# NESO - Region-id carbon intensity forward 24h (`regional_intensity_fw24h_regionid`)
...
curl --ssl-no-revoke -X GET \
  "https://api.carbonintensity.org.uk/regional/intensity/2024-01-15T00:00Z/fw24h/regionid/13" \
...
**Path pattern**: `{data_root}/bronze/neso/regional_intensity_fw24h_regionid/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
**Path pattern**: `{data_root}/silver/neso/regional_intensity_fw24h_regionid/year=<YYYY>/month=<MM>/regional_intensity_fw24h_regionid_<YYYYMMDD>.parquet`
**Transformer class**: `gridflow.silver.neso.carbon_intensity.RegionalIntensityFw24HRegionidTransformer`
