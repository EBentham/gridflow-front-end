---
source: neso
dataset_key: regional_intensity_fw48h_postcode
vendor: National Energy System Operator (NESO)
last_verified: 2026-05-08
layer_coverage: bronze, silver
---

# NESO - Postcode regional carbon intensity forward 48h (`regional_intensity_fw48h_postcode`)
...
curl --ssl-no-revoke -X GET \
  "https://api.carbonintensity.org.uk/regional/intensity/2024-01-15T00:00Z/fw48h/postcode/RG10" \
...
**Path pattern**: `{data_root}/bronze/neso/regional_intensity_fw48h_postcode/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
```json
{"data":{"regionid":12,"dnoregion":"SSE South","shortname":"South England","postcode":"RG41","data":[{"from":"2026-05-06T00:00Z","to":"2026-05-06T00:30Z","intensity":{"forecast":175,"index":"high"},"generationmix":[{"fuel":"gas","perc":50.2},{"fuel":"imports","perc":18.4}]}]}}
```
...
**Path pattern**: `{data_root}/silver/neso/regional_intensity_fw48h_postcode/year=<YYYY>/month=<MM>/regional_intensity_fw48h_postcode_<YYYYMMDD>.parquet`
**Transformer class**: `gridflow.silver.neso.carbon_intensity.RegionalIntensityFw48HPostcodeTransformer`
