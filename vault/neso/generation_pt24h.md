...
**Path pattern**: `{data_root}/bronze/neso/generation_pt24h/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
**Path pattern**: `{data_root}/silver/neso/generation_pt24h/year=<YYYY>/month=<MM>/generation_pt24h_<YYYYMMDD>.parquet`
