---
source: neso
dataset_key: intensity_date
vendor: National Energy System Operator (NESO)
last_verified: 2026-05-08
layer_coverage: bronze, silver
---

# NESO - Daily national carbon intensity (`intensity_date`)
...
curl --ssl-no-revoke -X GET \
  "https://api.carbonintensity.org.uk/intensity/date/2024-01-15" \
...
**Path pattern**: `{data_root}/bronze/neso/intensity_date/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
**Path pattern**: `{data_root}/silver/neso/intensity_date/year=<YYYY>/month=<MM>/intensity_date_<YYYYMMDD>.parquet`
**Transformer class**: `gridflow.silver.neso.carbon_intensity.IntensityDateTransformer`
