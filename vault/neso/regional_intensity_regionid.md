...
**Path pattern**: `{data_root}/bronze/neso/regional_intensity_regionid/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
**Path pattern**: `{data_root}/silver/neso/regional_intensity_regionid/year=<YYYY>/month=<MM>/regional_intensity_regionid_<YYYYMMDD>.parquet`
