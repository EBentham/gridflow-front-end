---
source: entsog
dataset_key: available_through_surrender
vendor: ENTSOG Transparency Platform
last_verified: 2026-05-08
layer_coverage: bronze, silver
---

# ENTSOG — Available Through Surrender (`indicator=Available through Surrender`)

## Overview

Capacity made available through surrender mechanism (CMP).
...
| Indicator | `Available through Surrender` (exact-case — vendor rejects lowercase or hyphen variants) |
...
|-----------|------|----------|-------------|---------|
| `indicator` | str | Yes | Exact-case indicator name | `Available through Surrender` |
...
curl --ssl-no-revoke -fsS \
  ...
  "https://transparency.entsog.eu/api/v1/operationalData?from=2026-05-06&to=2026-05-06&timeZone=UCT&indicator=Available%20through%20Surrender&periodType=day&pointDirection=UK-TSO-0001ITP-00005exit&forceDownload=true&limit=1000"
```
...
**Path pattern**: `{data_root}/bronze/entsog/available_through_surrender/<year>/<month>/<day>/raw_<uuid>.json`
...
```json
{
  ...
  "operationalData": [
    {
      "id": "1Available through SurrenderkWh/ddayUK-TSO-0001ITP-00005exitkWh/d2025-10-012026-10-01",
      "dataSet": 1,
      "indicator": "Available through Surrender",
      "periodType": "day",
...
**Path pattern**: `{data_root}/silver/entsog/available_through_surrender/year=YYYY/month=MM/available_through_surrender_YYYYMMDD.parquet`
**Transformer class**: `gridflow.silver.entsog.GenericEntsogJsonTransformer (subclass AvailableThroughSurrenderTransformer)`
