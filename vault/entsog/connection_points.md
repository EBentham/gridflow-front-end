...
**Path pattern**: `{data_root}/bronze/entsog/connection_points/<year>/<month>/<day>/raw_<uuid>.json` (one snapshot per weekly schedule)
...
**Path pattern**: `{data_root}/silver/entsog/connection_points.parquet` (single-file overwrite — `reference_dataset=True`)
