---
source: entsog
dataset_key: renominations
vendor: ENTSOG Transparency Platform
last_verified: 2026-05-08
layer_coverage: bronze, silver
---

# ENTSOG — Renominations (`indicator=Renomination`)

## Overview

Updated nominations submitted intra-day after the initial day-ahead nomination.
...
| Indicator | `Renomination` (exact-case — vendor rejects lowercase or hyphen variants) |
...
|-----------|------|----------|-------------|---------|
| `indicator` | str | Yes | Exact-case indicator name | `Renomination` |
...
curl --ssl-no-revoke -fsS \
  ...
  "https://transparency.entsog.eu/api/v1/operationalData?from=2026-05-06&to=2026-05-06&timeZone=UCT&indicator=Renomination&periodType=day&pointDirection=UK-TSO-0001ITP-00005exit&forceDownload=true&limit=1000"
```
...
**Path pattern**: `{data_root}/bronze/entsog/renominations/<year>/<month>/<day>/raw_<uuid>.json`
...
```json
{
  ...
  "operationalData": [
    {
      "id": "1Renominationday2026-05-062026-05-07UK-TSO-0001ITP-00005exitkWh/d",
      "dataSet": 1,
      "indicator": "Renomination",
      "periodType": "day",
...
**Path pattern**: `{data_root}/silver/entsog/renominations/year=YYYY/month=MM/renominations_YYYYMMDD.parquet`
**Transformer class**: `gridflow.silver.entsog.GenericEntsogJsonTransformer (subclass RenominationsTransformer)`
