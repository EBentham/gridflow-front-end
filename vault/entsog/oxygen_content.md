...
**Path pattern**: `{data_root}/bronze/entsog/oxygen_content/<year>/<month>/<day>/raw_<uuid>.json`
...
**Path pattern**: `{data_root}/silver/entsog/oxygen_content/year=YYYY/month=MM/oxygen_content_YYYYMMDD.parquet`
