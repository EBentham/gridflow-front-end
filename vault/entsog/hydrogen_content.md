...
Hydrogen (H2) volume fraction of gas delivered at the point.
...
| Indicator | `Hydrogen Content` (exact-case — vendor rejects lowercase or hyphen variants) |
...
|-----------|------|----------|-------------|---------|
| `indicator` | str | Yes | Exact-case indicator name | `Hydrogen Content` |
...
curl --ssl-no-revoke -fsS \
  ...
  "https://transparency.entsog.eu/api/v1/operationalData?from=2026-05-06&to=2026-05-06&timeZone=UCT&indicator=Hydrogen%20Content&periodType=day&pointDirection=UK-TSO-0001ITP-00005exit&forceDownload=true&limit=1000"
```
...
**Path pattern**: `{data_root}/bronze/entsog/hydrogen_content/<year>/<month>/<day>/raw_<uuid>.json`
...
**Path pattern**: `{data_root}/silver/entsog/hydrogen_content/year=YYYY/month=MM/hydrogen_content_YYYYMMDD.parquet`
**Transformer class**: `gridflow.silver.entsog.GenericEntsogJsonTransformer (subclass HydrogenContentTransformer)`
