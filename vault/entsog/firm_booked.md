---
source: entsog
dataset_key: firm_booked
vendor: ENTSOG Transparency Platform
last_verified: 2026-05-08
layer_coverage: bronze, silver
---

# ENTSOG — Firm Booked (`indicator=Firm Booked`)

## Overview

Firm capacity booked by shippers across all auctions and contract periods.
...
| Indicator | `Firm Booked` (exact-case — vendor rejects lowercase or hyphen variants) |
...
|-----------|------|----------|-------------|---------|
| `indicator` | str | Yes | Exact-case indicator name | `Firm Booked` |
...
curl --ssl-no-revoke -fsS \
  ...
  "https://transparency.entsog.eu/api/v1/operationalData?from=2026-05-06&to=2026-05-06&timeZone=UCT&indicator=Firm%20Booked&periodType=day&pointDirection=UK-TSO-0001ITP-00005exit&forceDownload=true&limit=1000"
```
...
**Path pattern**: `{data_root}/bronze/entsog/firm_booked/<year>/<month>/<day>/raw_<uuid>.json`
...
```json
{
  ...
  "operationalData": [
    {
      "id": "1Firm BookeddayUK-TSO-0001ITP-00005exitkWh/d2020-10-032029-10-01",
      "dataSet": 1,
      "indicator": "Firm Booked",
      "periodType": "day",
      "periodFrom": "2020-10-03T07:00:00+02:00",
      "periodTo": "2029-10-01T06:00:00+02:00",
      "operatorKey": "UK-TSO-0001",
      "tsoEicCode": "21X-GB-A-A0A0A-7",
      "operatorLabel": "National Grid Gas",
      "pointKey": "ITP-00005",
      ...
      "generalRemarks": "",
      "value": 0,
      "lastUpdateDateTime": "2020-09-30T12:55:41+02:00",
      "isUnlimited": "0",
      "flowStatus": "",
...
**Path pattern**: `{data_root}/silver/entsog/firm_booked/year=YYYY/month=MM/firm_booked_YYYYMMDD.parquet`
**Transformer class**: `gridflow.silver.entsog.GenericEntsogJsonTransformer (subclass FirmBookedTransformer)`
...
[
    {
        ...
        "indicator": "Firm Booked",
        "period_type": "day",
        "period_from": "2020-10-03T07:00:00+02:00",
        "period_to": "2029-10-01T06:00:00+02:00",
        "operator_key": "UK-TSO-0001",
        "tso_eic_code": "21X-GB-A-A0A0A-7",
        "operator_label": "National Grid Gas",
        "point_key": "ITP-00005",
        ...
        "general_remarks": "",
        "value": 0,
        "last_update_date_time": "2020-09-30T12:55:41+02:00",
        "is_unlimited": "0",
        "flow_status": "",
