---
source: entsog
dataset_key: interruptible_available
vendor: ENTSOG Transparency Platform
last_verified: 2026-05-08
layer_coverage: bronze, silver
---

# ENTSOG — Interruptible Available (`indicator=Interruptible Available`)

## Overview

Interruptible capacity remaining available for booking.
...
| Indicator | `Interruptible Available` (exact-case — vendor rejects lowercase or hyphen variants) |
...
|-----------|------|----------|-------------|---------|
| `indicator` | str | Yes | Exact-case indicator name | `Interruptible Available` |
...
curl --ssl-no-revoke -fsS \
  ...
  "https://transparency.entsog.eu/api/v1/operationalData?from=2026-05-06&to=2026-05-06&timeZone=UCT&indicator=Interruptible%20Available&periodType=day&pointDirection=UK-TSO-0001ITP-00005exit&forceDownload=true&limit=1000"
```
...
**Path pattern**: `{data_root}/bronze/entsog/interruptible_available/<year>/<month>/<day>/raw_<uuid>.json`
...
```json
{
  ...
  "operationalData": [
    {
      "id": "1Interruptible AvailabledayUK-TSO-0001ITP-00005exitkWh/d2022-04-042026-05-10",
      "dataSet": 1,
      "indicator": "Interruptible Available",
      "periodType": "day",
...
**Path pattern**: `{data_root}/silver/entsog/interruptible_available/year=YYYY/month=MM/interruptible_available_YYYYMMDD.parquet`
**Transformer class**: `gridflow.silver.entsog.GenericEntsogJsonTransformer (subclass InterruptibleAvailableTransformer)`
...
[
    {
        ...
        "general_remarks": "",
        "value": 0,
        "last_update_date_time": "2026-05-08T19:17:39+02:00",
        "is_unlimited": "0",
        "flow_status": "",
        "interruption_type": "",
