...
**Path pattern**: `{data_root}/bronze/entsog/interruptions/<year>/<month>/<day>/raw_<uuid>.json`
...
**Path pattern**: `{data_root}/silver/entsog/interruptions/year=YYYY/month=MM/interruptions_YYYYMMDD.parquet`
